...
public class TestRunner {
    ...
    public static void main(String[] args) {
        JUnitCore rangeTestRunner = new JUnitCore();
        Result result = rangeTestRunner.run(RangeTest.class);
        //Request request = Request.method(RangeTest.class, "RangeTest1");
        //Result rangeTestResult = rangeTestRunner.run(request);
